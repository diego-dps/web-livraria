...
const RegisterAuthors: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Houve um erro ao cadastrar o Autor', error);
    }
  };
  ...
  return (
    <div className="grid grid-cols-1 pt-10 gap-x-8 gap-y-8 md:grid-cols-3">
      <div className="px-4 sm:px-0">
        <h2 className="text-base font-semibold leading-7 text-gray-900">Informações do Author</h2>
        <p className="mt-1 text-sm leading-6 text-gray-600">Cadastre as informaçòes do Author</p>
      </div>
        ...
        <div className="px-4 py-6 sm:p-8">
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-400">Descreva as informações do Author</p>
            </div>
...
export default RegisterAuthors;
