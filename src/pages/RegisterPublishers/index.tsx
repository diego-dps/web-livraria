...
const RegisterPublishers: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Houve um erro ao cadastrar Editora', error);
    }
  };
        ...
        <div className="px-4 py-6 sm:p-8">
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-400">Descreva as informaçòes da editora</p>
            </div>
